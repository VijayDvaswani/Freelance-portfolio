...
export function Skills() {
  ...
  const skills = [
    ...
    },
    {
      ...
      title: t("skills.auto.title"),
      description: t("skills.auto.desc"),
      tools: t("skills.auto.tools"),
    ...
    },
    {
      ...
      title: t("skills.perf.title"),
      description: t("skills.perf.desc"),
      tools: t("skills.perf.tools"),
